...
export const ja = {
  ...
  onboarding: {
    ...
    skip: 'スキップ',
    homeTitle: 'ホーム画面に追加',
    homeBody: 'ホーム画面の空いた所を長押し →「＋」→「今すぐタイマー」を選んで追加。タップでワンタップ起動できます。',
    lockTitle: 'ロック画面にも追加',
    lockBody: 'ロック画面を長押し →「カスタマイズ」→「ロック画面」→ ウィジェット枠をタップ →「今すぐタイマー」。ロックしたまま起動できます。',
    conceptTitle: 'ウィジェットからワンタップ',
    conceptBody: 'よく使う時間をプリセットにして、ウィジェットからタイマーを一瞬で起動できます。',
    startTitle: '準備完了',
    startBody: 'さっそく始めましょう。終了は消音/集中モード中でも音と画面でお知らせします。',
  },
