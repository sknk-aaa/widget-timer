...
export const en: Strings = {
  ...
  settings: {
    ...
    share: 'Tell a friend',
    shareMessage: 'TimerTiles — start a timer in one tap from your widget.',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Long-press an empty spot on your Home Screen → "+" → choose "TimerTiles" to add it.',
      },
      {
  ...
  pro: {
    ...
    settingsTitle: 'More room with Pro',
    settingsSub: 'Multiple widgets and unlimited presets.',
    settingsFeatureWidgets: 'Multiple widgets',
    settingsFeaturePresets: 'Unlimited presets',
    compareFree: 'Free',
    compareFreeSub: '1 board, 3 presets',
    comparePro: 'Pro',
    compareProSub: 'Unlimited boards and presets',
    featureBoards: 'Multiple widget boards',
    featureBoardsSub: 'Place several widgets and show different timers for each use case.',
    featurePresets: 'Save as many presets as you want',
    featurePresetsSub: 'Keep timers for cooking, naps, study, breaks, and more.',
    featureOneTime: 'Pay once, use forever',
    featureOneTimeSub: 'No subscription. No ads. No tracking.',
    pillOnce: 'One-time',
    pillNoAds: 'No ads',
  ...
  onboarding: {
    ...
    start: 'Get started',
    skip: 'Skip',
    ringsTitle: 'Rings through Silent & Focus.',
    ringsBody: 'Reliable like the built-in alarm — new in iOS 26.',
    onetapTitle: 'One tap from your Home Screen.',
    onetapBody: 'Put your timers on a widget and start instantly.',
