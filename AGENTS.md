...
- 作業開始時は `docs/HANDOFF.md` と `docs/MARKETING.md` を読み、現在フェーズを把握する。現在はApp Store公開済み・次バージョンのアップデート申請中なので、公開後の初速、レビュー/不具合監視、SNS導線、ASO、次アップデート候補を自分から意識する。
...
- **App Store公開済み。最新ビルドで次バージョンのアップデート申請済み。** 最新状態・残タスク・既知の問題は `docs/HANDOFF.md`。
